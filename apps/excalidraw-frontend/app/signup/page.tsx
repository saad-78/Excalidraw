            ...
            <div className="w-full max-w-md relative z-10">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 rounded-xl border-2 bg-slate-800/50 text-white placeholder-slate-500 transition-all duration-300 outline-none font-medium ${
                                    focusedField === "name"
                                        ? "border-cyan-500/60 bg-slate-800/80 shadow-lg shadow-cyan-500/20"
                    ...
                    <button
                        ...
                        className={`w-full mt-8 py-3 px-4 rounded-xl font-bold text-white tracking-wide transition-all duration-300 flex items-center justify-center gap-2 uppercase text-sm ${
                            loading
                                ...
                                : "bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 hover:shadow-2xl hover:shadow-blue-500/50 hover:scale-105 active:scale-95"
                        }`}
                    >
                        {loading ? (
                            <>
                ...
                {/* <div className="mt-8 text-center">
                    <p className="text-slate-600 text-xs">
                        ...
                        <a
                            href="/signin"
                            className="font-bold text-transparent bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text hover:from-cyan-300 hover:to-blue-300 transition-all duration-300"
                        >
                            Sign In Here
                        </a>
                    </p>
